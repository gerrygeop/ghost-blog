        ...
        <div class="grid grid-cols-1 gap-6">
            ...
            <div>
                ...
                <textarea
                    ...
                    cols="30"
                    rows="10"
                    class="block w-full h-98 px-4 py-2 mt-2 text-gray-700 border-2 border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-indigo-500"><?= $data['blog']['content']; ?></textarea>
            </div>
